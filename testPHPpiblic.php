...
class Browser
{
    ...
    */
    ...
    {
        return "<strong>浏览器名称:</strong> {$this->getBrowser()}<br/>\n" .
        "<strong>浏览器版本:</strong> {$this->getVersion()}<br/>\n" .
        "<strong>浏览器UserAgent信息:</strong> {$this->getUserAgent()}<br/>\n" .
        "<strong>操作系统信息:</strong> {$this->getPlatform()}<br/>";
    }
